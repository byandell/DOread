...
```{r}
setup_molecule_peaks <- function(datapath, filename, groupname, tissue) {
...
analyses_molecule <- peaks_molecule %>%
  ...
  mutate(model = "normal",
         ...
         sex = TRUE,
         DOwave = TRUE,
         BatchLiverLipid = (pheno_group == "LiverLipid"),
         BatchCecumLipid = (pheno_group == "CecumLipid"),
         BatchLiverMetab = (pheno_group == "LiverMetab"),
         BatchPlasmaLipid = (pheno_group == "PlasmaLipid"))
```
