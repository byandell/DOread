...
```{r}
liverz <- readRDS(file.path(datapath, "jax", 
                            "attie_liver_lipids_zscore_normalized.rds"))
metabz <- readRDS(file.path(datapath, "jax",
                            "attie_liver_metabolites_zscore_normalized.rds"))
plasmaz <- readRDS(file.path(datapath, "jax",
                            "attie_plasma_lipids_zscore_normalized.rds"))
cecumz <- readRDS(file.path(datapath, "jax",
...
```{r}
library(ggplot2)
metabn <- readRDS(file.path(datapath, "jax",
